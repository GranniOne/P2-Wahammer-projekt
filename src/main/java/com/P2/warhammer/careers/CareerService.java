...
public class CareerService {
    ...
    public Career addCareer(String Id, String Name, List<String> levelCharacterticsList, List<String> levelTrappingsList, List<String> levelStatusList, List<String> levelTalentsList, List<List<String>> levelSkillsList, String socialClass) {
